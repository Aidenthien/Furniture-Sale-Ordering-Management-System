...
public class SalesOrderQuotation extends Furniture {
    ...
    public SalesOrderQuotation(String salesId, String salesPersonId, String date, String customerName, String customerContactNo, String customerAddress, String itemName, String itemType, String deliveryFees, String discount, String price, String quantity, String status) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (list.length >= 12) {
                    ...
                    if (salespersonId.equals(dataSalespersonId)) {
                        quotations.add(new SalesOrderQuotation(list[0], list[1], list[2], list[3], list[4], list[5], list[6], list[7], list[8], list[9], list[10], list[11], list[12]));
                    }
                } else {
    ...
    public static void importDataToTable(ArrayList<SalesOrderQuotation> quotations, JTable table){
        ...
        for(SalesOrderQuotation q:quotations){
            String[] allDataRow = {q.getSalesId(),q.getSalesPersonId(),q.getDate(),q.getCustomerName(),
                ...
                q.getDiscount(),q.getPrice(),q.getQuantity(),q.getStatus()};
        ...
        try {
            ...
            for (SalesOrderQuotation i : quotations) {
                String entry = i.getSalesId() + ", " + i.getSalesPersonId() + ", " + i.getDate() + ", " + i.getCustomerName() + ", "
                        ...
                        + i.getDeliveryFees() + ", " + i.getDiscount() + ", " + i.getPrice() + ", " + i.getQuantity() + ", " + i.getStatus();
